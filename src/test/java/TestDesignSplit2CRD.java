...
public class TestDesignSplit2CRD {
	...
	public static void main(String[] args) {
		...
		String fieldBookName = "fieldbookSplit2CRD";
		String main = "Fertilizer";
		String sub = "Nitrogen";
		String ssub = "Variety";
		String sssub = null;
		String[] factorID = {"F", "N", "V"}; // factor ID for main plot, sub plot and sub-sub plot factor respectively
		Integer[] factorLevel = {5, 4, 4}; 	 // factor level for main plot, sub plot and sub-sub plot factor respectively
		Integer rep = 6;
		Integer rowPerBlk = 1; 			// for Split, Split2 and Split3 Plot Design in CRD and LSD, rowPerBlk is equal to 1
		Integer rowPerMain = 2;
		Integer rowPerSub = 2; 			
		Integer rowPerSubSub = 1; 		// for Split Plot and Split-Split Plot Design, rowPerSubSub is equal to 1
		...
		rServeManager.doDesignSplit(path, fieldBookName, main, sub, ssub, sssub, factorID, factorLevel, rep, trial, design, numFieldRow, rowPerBlk, rowPerMain, rowPerSub, rowPerSubSub, fieldOrder);
//			
