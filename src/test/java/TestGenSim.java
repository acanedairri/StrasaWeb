...
public class TestGenSim {
	...
	public static void main(String[] args) {
		...
		GeneticSimilarityModel genSimModel = new GeneticSimilarityModel();
		
		genSimModel.initTestVarsPedigree();
//		genSimModel.initTestVarsMarker();
		rServeManager.doGenSim(genSimModel);
