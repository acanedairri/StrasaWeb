...
public interface StudyMapper {
	...
	@Insert({
			...
			"#{datasets,jdbcType=INTEGER}, #{startyear,jdbcType=VARCHAR}, ",
			"#{endyear,jdbcType=VARCHAR}, #{remarks,jdbcType=VARCHAR}, ",
			"#{shared,jdbcType=BIT})" })
	...
	@Results({
			...
			@Result(column = "datasets", property = "datasets", jdbcType = JdbcType.INTEGER),
	...
	@Select({
			"select",
			"id, userid, programid, projectid, name, description, studytypeid, datasets, ",
			"startyear, endyear, remarks, shared", "from study",
	...
	@Update({ "update study", "set userid = #{userid,jdbcType=INTEGER},",
			...
			"datasets = #{datasets,jdbcType=INTEGER},",
