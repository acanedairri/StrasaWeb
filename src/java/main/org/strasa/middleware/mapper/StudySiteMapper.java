...
public interface StudySiteMapper {
     ...
     * This method corresponds to the database table studysite
     *
     ...
     */
    @Insert({
        "insert into studysite (studyid, year, ",
        "season, sitename, ",
        "sitelocation, ecotypeid, ",
        "soiltype, soilph)",
        "values (#{studyid,jdbcType=INTEGER}, #{year,jdbcType=VARCHAR}, ",
        "#{season,jdbcType=VARCHAR}, #{sitename,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, studyid, year, season, sitename, sitelocation, ecotypeid, soiltype, soilph",
        "from studysite",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
    ...
    int updateByExampleSelective(@Param("record") StudySite record, @Param("example") StudySiteExample example);
    ...
    int updateByExample(@Param("record") StudySite record, @Param("example") StudySiteExample example);
