...
public class StudyAgronomySqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        StudyAgronomyExample example = (StudyAgronomyExample) parameter.get("example");
     ...
     * @mbggenerated Wed Oct 09 16:20:41 SGT 2013
     */
    protected void applyWhere(StudyAgronomyExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
