...
public interface GermplasmMapper {
	 ...
	 */
	@Insert({
			"insert into germplasm (userid, gid, ",
			...
			"source, remarks)",
			"values (#{userid,jdbcType=INTEGER}, #{gid,jdbcType=INTEGER}, ",
	...
	@Select({
			"select",
			"id, userid, gid, germplasmname, othername, breeder, germplasmtypeid, irnumber, ",
	 ...
	 * @mbggenerated  Thu Oct 17 13:40:28 SGT 2013
	 */
	@Update({ "update germplasm", "set userid = #{userid,jdbcType=INTEGER},",
