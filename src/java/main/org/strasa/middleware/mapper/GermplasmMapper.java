...
public interface GermplasmMapper {
    ...
    int updateByExampleSelective(@Param("record") Germplasm record, @Param("example") GermplasmExample example);
    ...
    int updateByExample(@Param("record") Germplasm record, @Param("example") GermplasmExample example);
