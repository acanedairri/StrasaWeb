...
public interface StudyGermplasmCharacteristicsMapper {
    ...
    List<StudyGermplasmCharacteristics> selectByExample(StudyGermplasmCharacteristicsExample example);
    ...
    int updateByExampleSelective(@Param("record") StudyGermplasmCharacteristics record, @Param("example") StudyGermplasmCharacteristicsExample example);
    ...
    int updateByExample(@Param("record") StudyGermplasmCharacteristics record, @Param("example") StudyGermplasmCharacteristicsExample example);
