...
public class KeyGrainQualitySqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        KeyGrainQualityExample example = (KeyGrainQualityExample) parameter.get("example");
     ...
     * @mbggenerated Thu Oct 10 13:49:48 SGT 2013
     */
    protected void applyWhere(KeyGrainQualityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
