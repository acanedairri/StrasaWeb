...
import org.strasa.middleware.model.UserExample.Criteria;
import org.strasa.middleware.model.UserExample.Criterion;
...
public class UserSqlProvider {
	...
	public String insertSelective(User record) {
		...
		if (record.getRole() != null) {
			VALUES("role", "#{role,jdbcType=CHAR}");
		}
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		...
		if (record.getRole() != null) {
			SET("role = #{record.role,jdbcType=CHAR}");
		}
		if (record.getDateregistered() != null) {
