...
public interface GeorefMapper {
     ...
     * This method corresponds to the database table georef
     *
    ...
    int updateByExampleSelective(@Param("record") Georef record, @Param("example") GeorefExample example);
    ...
    int updateByExample(@Param("record") Georef record, @Param("example") GeorefExample example);
}