...
public interface GermplasmCharacteristicsMapper {
     ...
     */
    @Delete({
        "delete from germplasmcharacteristics",
    ...
    List<GermplasmCharacteristics> selectByExample(GermplasmCharacteristicsExample example);
    ...
    int updateByExampleSelective(@Param("record") GermplasmCharacteristics record, @Param("example") GermplasmCharacteristicsExample example);
    ...
    int updateByExample(@Param("record") GermplasmCharacteristics record, @Param("example") GermplasmCharacteristicsExample example);
