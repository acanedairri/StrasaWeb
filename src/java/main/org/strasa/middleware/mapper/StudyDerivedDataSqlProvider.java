...
public class StudyDerivedDataSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        StudyDerivedDataExample example = (StudyDerivedDataExample) parameter.get("example");
     ...
     * @mbggenerated Wed Oct 09 16:20:41 SGT 2013
     */
    protected void applyWhere(StudyDerivedDataExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
