...
public interface GermplasmReleaseInfoMapper {
    ...
    List<GermplasmReleaseInfo> selectByExample(GermplasmReleaseInfoExample example);
    ...
    int updateByExampleSelective(@Param("record") GermplasmReleaseInfo record, @Param("example") GermplasmReleaseInfoExample example);
    ...
    int updateByExample(@Param("record") GermplasmReleaseInfo record, @Param("example") GermplasmReleaseInfoExample example);
