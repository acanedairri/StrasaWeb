...
public interface ExtensionDataMapper {
    ...
    @Select({
        "select",
        "id, germplasmname, year, location, area, datasource",
        "from extensiondata",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
    ...
    int updateByExampleSelective(@Param("record") ExtensionData record, @Param("example") ExtensionDataExample example);
    ...
    int updateByExample(@Param("record") ExtensionData record, @Param("example") ExtensionDataExample example);
