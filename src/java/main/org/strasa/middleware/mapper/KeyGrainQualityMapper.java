...
public interface KeyGrainQualityMapper {
     ...
     * This method corresponds to the database table keygrainquality
     *
     ...
     */
    @Insert({
        "insert into keygrainquality (value)",
    ...
    int updateByExampleSelective(@Param("record") KeyGrainQuality record, @Param("example") KeyGrainQualityExample example);
    ...
    int updateByExample(@Param("record") KeyGrainQuality record, @Param("example") KeyGrainQualityExample example);
