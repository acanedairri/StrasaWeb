...
public interface KeyAbioticMapper {
    ...
    int updateByExampleSelective(@Param("record") KeyAbiotic record, @Param("example") KeyAbioticExample example);
    ...
    int updateByExample(@Param("record") KeyAbiotic record, @Param("example") KeyAbioticExample example);
