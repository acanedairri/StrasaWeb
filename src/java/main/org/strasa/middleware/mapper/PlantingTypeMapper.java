...
public interface PlantingTypeMapper {
     ...
     */
    @Insert({
        "insert into plantingtype (planting)",
    ...
    int updateByExampleSelective(@Param("record") PlantingType record, @Param("example") PlantingTypeExample example);
    ...
    int updateByExample(@Param("record") PlantingType record, @Param("example") PlantingTypeExample example);
