...
public interface StudyDerivedDataMapper {
     ...
     * This method corresponds to the database table studyderiveddata
     *
    ...
    int updateByExampleSelective(@Param("record") StudyDerivedData record, @Param("example") StudyDerivedDataExample example);
    ...
    int updateByExample(@Param("record") StudyDerivedData record, @Param("example") StudyDerivedDataExample example);
}