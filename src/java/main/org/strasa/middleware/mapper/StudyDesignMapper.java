...
public interface StudyDesignMapper {
    ...
    int updateByExampleSelective(@Param("record") StudyDesign record, @Param("example") StudyDesignExample example);
    ...
    int updateByExample(@Param("record") StudyDesign record, @Param("example") StudyDesignExample example);
