...
public class StudyRawDataByDataColumnSqlProvider {
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		StudyRawDataByDataColumn record = (StudyRawDataByDataColumn) parameter
				.get("record");
		StudyRawDataByDataColumnExample example = (StudyRawDataByDataColumnExample) parameter
				.get("example");
		BEGIN();
		UPDATE("studyrawdata");
		if (record.getStudyid() != null) {
	 ...
	 * @mbggenerated  Fri Nov 08 10:39:08 SGT 2013
	 */
	protected void applyWhere(StudyRawDataByDataColumnExample example,
