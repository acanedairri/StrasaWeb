...
public interface GermplasmTypeMapper {
     ...
     */
    @Insert({
        "insert into germplasmtype (germplasmtype, description)",
    ...
    int updateByExampleSelective(@Param("record") GermplasmType record, @Param("example") GermplasmTypeExample example);
    ...
    int updateByExample(@Param("record") GermplasmType record, @Param("example") GermplasmTypeExample example);
