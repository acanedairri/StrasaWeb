...
public interface KeyMajorGenesMapper {
     ...
     */
    @Insert({
        "insert into keymajorgenes (value)",
    ...
    int updateByExampleSelective(@Param("record") KeyMajorGenes record, @Param("example") KeyMajorGenesExample example);
    ...
    int updateByExample(@Param("record") KeyMajorGenes record, @Param("example") KeyMajorGenesExample example);
