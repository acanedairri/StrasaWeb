...
public interface EcotypeMapper {
    ...
    int updateByExampleSelective(@Param("record") Ecotype record, @Param("example") EcotypeExample example);
    ...
    int updateByExample(@Param("record") Ecotype record, @Param("example") EcotypeExample example);
