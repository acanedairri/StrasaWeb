...
public interface ProjectMapper {
	...
	@Insert({
			...
			"objective, pi, leadinginstitute, ",
			"collaborators, fundingagency)",
			"values (#{userid,jdbcType=INTEGER}, #{name,jdbcType=VARCHAR}, ",
			"#{objective,jdbcType=VARCHAR}, #{pi,jdbcType=VARCHAR}, #{leadinginstitute,jdbcType=VARCHAR}, ",
	...
	@Select({
			"select",
			"id, userid, name, objective, pi, leadinginstitute, collaborators, fundingagency",
