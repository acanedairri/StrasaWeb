...
public class StudyVariableSqlProvider {
	...
	public String insertSelective(StudyVariable record) {
		...
		if (record.getTraitcode() != null) {
			VALUES("traitcode", "#{traitcode,jdbcType=VARCHAR}");
		}
		if (record.getDescription() != null) {
			VALUES("description", "#{description,jdbcType=VARCHAR}");
		}
		if (record.getMethodid() != null) {
			VALUES("methodid", "#{methodid,jdbcType=INTEGER}");
		}
		if (record.getScaleid() != null) {
			VALUES("scaleid", "#{scaleid,jdbcType=INTEGER}");
		}
		if (record.getApplytofilter() != null) {
			VALUES("applytofilter", "#{applytofilter,jdbcType=BIT}");
		}
		return SQL();
	}
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		...
		if (record.getTraitcode() != null) {
			SET("traitcode = #{record.traitcode,jdbcType=VARCHAR}");
		}
		if (record.getDescription() != null) {
		...
		if (record.getScaleid() != null) {
			SET("scaleid = #{record.scaleid,jdbcType=INTEGER}");
		}
		if (record.getApplytofilter() != null) {
			SET("applytofilter = #{record.applytofilter,jdbcType=BIT}");
		}
	...
	public String updateByPrimaryKeySelective(StudyVariable record) {
		...
		if (record.getApplytofilter() != null) {
			SET("applytofilter = #{applytofilter,jdbcType=BIT}");
		}
