...
public class StudyGermplasmSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        StudyGermplasmExample example = (StudyGermplasmExample) parameter.get("example");
     ...
     * @mbggenerated Fri Oct 25 13:11:54 SGT 2013
     */
    protected void applyWhere(StudyGermplasmExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
