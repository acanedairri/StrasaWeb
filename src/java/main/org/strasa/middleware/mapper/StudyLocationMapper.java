...
public interface StudyLocationMapper {
    ...
    int updateByExampleSelective(@Param("record") StudyLocation record, @Param("example") StudyLocationExample example);
    ...
    int updateByExample(@Param("record") StudyLocation record, @Param("example") StudyLocationExample example);
