...
public interface StudyLocationMapper {
	 ...
	 * @mbggenerated  Fri Nov 08 10:39:08 SGT 2013
	 */
	@Insert({ "insert into studylocation (studyid, locationid)",
			"values (#{studyid,jdbcType=INTEGER}, #{locationid,jdbcType=INTEGER})" })
	 ...
	 * @mbggenerated  Fri Nov 08 10:39:08 SGT 2013
	 */
	@Select({ "select", "id, studyid, locationid", "from studylocation",
