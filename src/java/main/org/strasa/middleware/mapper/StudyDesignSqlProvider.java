...
public class StudyDesignSqlProvider {
    ...
    public String insertSelective(StudyDesign record) {
        ...
        if (record.getTreatmentstructure() != null) {
            VALUES("treatmentstructure", "#{treatmentstructure,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        StudyDesignExample example = (StudyDesignExample) parameter.get("example");
     ...
     * @mbggenerated Fri Oct 25 13:11:54 SGT 2013
     */
    protected void applyWhere(StudyDesignExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
