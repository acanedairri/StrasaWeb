...
public class StudyLocationSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        StudyLocationExample example = (StudyLocationExample) parameter.get("example");
     ...
     * @mbggenerated Wed Oct 09 16:20:43 SGT 2013
     */
    protected void applyWhere(StudyLocationExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
