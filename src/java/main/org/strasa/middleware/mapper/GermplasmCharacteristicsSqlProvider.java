...
public class GermplasmCharacteristicsSqlProvider {
	...
	public String insertSelective(GermplasmCharacteristics record) {
		...
		if (record.getKeyvalue() != null) {
			VALUES("keyvalue", "#{keyvalue,jdbcType=VARCHAR}");
		}
		return SQL();
	}
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		GermplasmCharacteristics record = (GermplasmCharacteristics) parameter
				.get("record");
		GermplasmCharacteristicsExample example = (GermplasmCharacteristicsExample) parameter
				.get("example");
		BEGIN();
		...
		if (record.getKeyvalue() != null) {
			SET("keyvalue = #{record.keyvalue,jdbcType=VARCHAR}");
		}
	 ...
	 * @mbggenerated  Mon Dec 16 13:38:57 SGT 2013
	 */
	protected void applyWhere(GermplasmCharacteristicsExample example,
