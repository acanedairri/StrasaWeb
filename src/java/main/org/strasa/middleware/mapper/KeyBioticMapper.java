...
public interface KeyBioticMapper {
    ...
    int updateByExampleSelective(@Param("record") KeyBiotic record, @Param("example") KeyBioticExample example);
    ...
    int updateByExample(@Param("record") KeyBiotic record, @Param("example") KeyBioticExample example);
