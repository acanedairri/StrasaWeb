...
import org.strasa.middleware.model.GermplasmReleaseInfoExample.Criteria;
import org.strasa.middleware.model.GermplasmReleaseInfoExample.Criterion;
import org.strasa.middleware.model.GermplasmReleaseInfoExample;

public class GermplasmReleaseInfoSqlProvider {
     ...
     */
    public String countByExample(GermplasmReleaseInfoExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Wed Oct 09 16:20:41 SGT 2013
     */
    public String deleteByExample(GermplasmReleaseInfoExample example) {
        BEGIN();
     ...
     * @mbggenerated Wed Oct 09 16:20:41 SGT 2013
     */
    public String insertSelective(GermplasmReleaseInfo record) {
        BEGIN();
     ...
     * @mbggenerated Wed Oct 09 16:20:41 SGT 2013
     */
    public String selectByExample(GermplasmReleaseInfoExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        GermplasmReleaseInfo record = (GermplasmReleaseInfo) parameter.get("record");
        GermplasmReleaseInfoExample example = (GermplasmReleaseInfoExample) parameter.get("example");
     ...
     * @mbggenerated Wed Oct 09 16:20:41 SGT 2013
     */
    public String updateByPrimaryKeySelective(GermplasmReleaseInfo record) {
        BEGIN();
        UPDATE("germplasmreleaseinfo");
     ...
     * @mbggenerated Wed Oct 09 16:20:41 SGT 2013
     */
    protected void applyWhere(GermplasmReleaseInfoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
