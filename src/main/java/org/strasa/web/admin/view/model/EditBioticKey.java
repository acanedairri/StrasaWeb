...
public class EditBioticKey {
	...
	StudyGermplasmCharacteristicsManagerImpl studyGermplasmCharMan;
	...
	public void init(@ContextParam(ContextType.VIEW) Component view){
		...
		studyGermplasmCharMan = new StudyGermplasmCharacteristicsManagerImpl();
	...
	public void delete(@BindingParam("id") final Integer Id, @BindingParam("keyName") String keyName){
		if(!studyGermplasmCharMan.isCharacteristicValueExisting("Biotic", keyName)){
