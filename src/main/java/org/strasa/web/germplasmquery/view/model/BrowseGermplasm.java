...
public class BrowseGermplasm {
	...
	@NotifyChange("*")
	@Command
	public void SearchGermplasm(@ContextParam(ContextType.COMPONENT) Component component, @ContextParam(ContextType.VIEW) Component view) {
		Combobox cmbSearchKey = (Combobox) component.getFellow("cmbSearchKey");
		...
		if (this.germplasmList.size() == 1) {
			...
			// Groupbox groupBoxInfo= (Groupbox)
			// component.getFellow("GermplasmDetailId");
			// groupBoxInfo.setVisible(false);
			//
			// Groupbox groupBoxStudyTested= (Groupbox)
			// component.getFellow("StudyTestedId");
	...
	private List<Germplasm> getGermplasmByKeyCharacteristics() {
		...
		try {
			...
			return toreturn = browseStudyManagerImpl.getGermplasmKeyCharacteristics(keyCriteria);
	...
	@NotifyChange("*")
	@Command
	public void ResetKeyChar(@ContextParam(ContextType.COMPONENT) Component component, @ContextParam(ContextType.VIEW) Component view) {
	...
	@NotifyChange("*")
	@GlobalCommand
	public void openGermplasmDetailInGermplasm(@ContextParam(ContextType.COMPONENT) Component component, @ContextParam(ContextType.VIEW) Component view, @BindingParam("germplasmId") Integer id, @BindingParam("gname") String gname) {
		...
		if (!activeGermplasmIds.containsKey(id)) {
			...
			studyInformationPage.setDynamicProperty("gref", id);
