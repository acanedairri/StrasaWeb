...
public class Index {
	// public static ArrayList<Integer> activeStudyIds = new
	// ArrayList<Integer>();
	...
	@NotifyChange
	@GlobalCommand
	public void openGermplasmDetailInAcrossStudy(@ContextParam(ContextType.COMPONENT) Component component, @ContextParam(ContextType.VIEW) Component view, @BindingParam("gname") String gname, @BindingParam("gref") Integer gref) {
		...
		if (!activeStudyIds.containsKey(gname)) {
			...
			studyInformationPage.setDynamicProperty("gref", gref);
	...
	@NotifyChange
	@GlobalCommand
	public void openStudyDetailInAcrossStudy(@ContextParam(ContextType.COMPONENT) Component component, @ContextParam(ContextType.VIEW) Component view, @BindingParam("studyid") Integer studyId, @BindingParam("studyName") String studyName) {
	...
	@NotifyChange
	@GlobalCommand
	public void openStudyDetailInGermplasm(@ContextParam(ContextType.COMPONENT) Component component, @ContextParam(ContextType.VIEW) Component view, @BindingParam("studyid") Integer studyId, @BindingParam("studyName") String studyName) {
