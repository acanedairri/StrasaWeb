...
import org.strasa.middleware.model.ExtensionDataExample.Criteria;
import org.strasa.middleware.model.ExtensionDataExample.Criterion;

public class ExtensionDataSqlProvider {
	 ...
	 */
	public String countByExample(ExtensionDataExample example) {
		BEGIN();
		SELECT("count(*)");
		FROM("extensiondata");
	 ...
	 * @mbggenerated  Fri Feb 07 10:48:01 SGT 2014
	 */
	public String deleteByExample(ExtensionDataExample example) {
		BEGIN();
		DELETE_FROM("extensiondata");
		applyWhere(example, false);
		return SQL();
	}
	 ...
	 * @mbggenerated  Fri Feb 07 10:48:01 SGT 2014
	 */
	public String insertSelective(ExtensionData record) {
		BEGIN();
		INSERT_INTO("extensiondata");
	 ...
	 * @mbggenerated  Fri Feb 07 10:48:01 SGT 2014
	 */
	public String selectByExample(ExtensionDataExample example) {
		BEGIN();
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		ExtensionData record = (ExtensionData) parameter.get("record");
		ExtensionDataExample example = (ExtensionDataExample) parameter
				.get("example");
		BEGIN();
	 ...
	 * @mbggenerated  Fri Feb 07 10:48:01 SGT 2014
	 */
	public String updateByPrimaryKeySelective(ExtensionData record) {
		BEGIN();
		UPDATE("extensiondata");
		if (record.getProgramid() != null) {
	 ...
	 * @mbggenerated  Fri Feb 07 10:48:01 SGT 2014
	 */
	protected void applyWhere(ExtensionDataExample example,
