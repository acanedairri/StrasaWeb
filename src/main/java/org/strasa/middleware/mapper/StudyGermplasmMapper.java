...
public interface StudyGermplasmMapper {
	 ...
	 */
	@Insert({
			"insert into studygermplasm (gref, studyid, ",
			"dataset, gid, germplasmname, ",
			"othername, breeder, ",
			...
			"#{dataset,jdbcType=INTEGER}, #{gid,jdbcType=INTEGER}, #{germplasmname,jdbcType=VARCHAR}, ",
	...
	@Select({
			"select",
			"id, gref, studyid, dataset, gid, germplasmname, othername, breeder, germplasmtypeid, ",
