...
public interface StudyGermplasmMapper {
	 ...
	 * @mbggenerated  Sat Feb 01 19:13:07 SGT 2014
	 */
	@Insert({ "insert into studygermplasm (gref, studyid, ", "dataset, userid)", "values (#{gref,jdbcType=INTEGER}, #{studyid,jdbcType=INTEGER}, ", "#{dataset,jdbcType=INTEGER}, #{userid,jdbcType=INTEGER})" })
	...
	@Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "gref", property = "gref", jdbcType = JdbcType.INTEGER), @Result(column = "studyid", property = "studyid", jdbcType = JdbcType.INTEGER),
			@Result(column = "dataset", property = "dataset", jdbcType = JdbcType.INTEGER), @Result(column = "userid", property = "userid", jdbcType = JdbcType.INTEGER) })
	 ...
	 * @mbggenerated  Sat Feb 01 19:13:07 SGT 2014
	 */
	@Select({ "select", "id, gref, studyid, dataset, userid", "from studygermplasm", "where id = #{id,jdbcType=INTEGER}" })
	@Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "gref", property = "gref", jdbcType = JdbcType.INTEGER), @Result(column = "studyid", property = "studyid", jdbcType = JdbcType.INTEGER),
			@Result(column = "dataset", property = "dataset", jdbcType = JdbcType.INTEGER), @Result(column = "userid", property = "userid", jdbcType = JdbcType.INTEGER) })
	...
	int updateByExampleSelective(@Param("record") StudyGermplasm record, @Param("example") StudyGermplasmExample example);
	...
	int updateByExample(@Param("record") StudyGermplasm record, @Param("example") StudyGermplasmExample example);
	 ...
	 * @mbggenerated  Sat Feb 01 19:13:07 SGT 2014
	 */
	@Update({ "update studygermplasm", "set gref = #{gref,jdbcType=INTEGER},", "studyid = #{studyid,jdbcType=INTEGER},", "dataset = #{dataset,jdbcType=INTEGER},", "userid = #{userid,jdbcType=INTEGER}", "where id = #{id,jdbcType=INTEGER}" })
