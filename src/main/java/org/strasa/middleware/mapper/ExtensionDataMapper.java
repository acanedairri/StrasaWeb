...
public interface ExtensionDataMapper {
	...
	@Insert({
			...
			"#{country,jdbcType=VARCHAR}, #{yearrelease,jdbcType=VARCHAR}, ",
			"#{seedavailability,jdbcType=INTEGER})" })
	...
	@Select({
			"select",
			"id, germplasmname, year, location, area, datasource, country, yearrelease, seedavailability",
